                    ...
                    <>
                      ...
                      {driverFile && (
                        <>
                          ...
                          >
                            <FontAwesomeIcon icon="upload" spin={uploadingDriver} />
                            &nbsp;
                            {uploadingDriver ? (
              ...
              {provisioningMode === 'USE_EXISTING' && (
                <>
                  ...
                  <div className="mb-3">
                    ...
                    >
                      <FontAwesomeIcon icon={testingConnection ? 'spinner' : 'plug'} spin={testingConnection} />
                      &nbsp;
                      {testingConnection ? (
                    ...
                    {connectionTestResult && (
                      <div className={`mt-2 alert alert-${connectionTestResult.success ? 'success' : 'danger'}`}>
                        <strong>{connectionTestResult.success ? '✓' : '✗'}</strong> {connectionTestResult.message}
                        {connectionTestResult.connectionTimeMs && (
                          <div className="small">Connection time: {connectionTestResult.connectionTimeMs}ms</div>
                        )}

...
public class WebConfigurer implements WebFluxConfigurer {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Development-friendly: Always allow localhost:9000 and localhost:9060 for local frontend development
        // This allows frontend development (npm start) even when backend is in production
        ...
        if (!hasLocalhost9000) {
            ...
            LOG.info("Auto-added localhost:9000 to CORS allowed origins for local frontend development");
        }
        if (!hasLocalhost9060) {
            allowedOrigins.add("http://localhost:9060");
            allowedOrigins.add("https://localhost:9060");
            LOG.info("Auto-added localhost:9060 to CORS allowed origins for local frontend development");
        }

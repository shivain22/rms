...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.atparui.rms.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.atparui.rms.security.DomainUserDetailsService", "createSpringSecurityUser");
